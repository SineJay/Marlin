...
#define STRING_CONFIG_H_AUTHOR "(JT, Ender 3 SRK1.3 TMC2130)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender 3 SKR 2130"
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (X_HYBRID_THRESHOLD*60)
